...
return new class extends Migration
{
    ...
    {
        Schema::create('buy_cars_translations', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('carroserie_en')->nullable();
            $table->string('carroserie_de')->nullable();
            $table->string('color_en')->nullable();
            $table->string('color_de')->nullable();
    ...
    {
        Schema::dropIfExists('buy_cars_translations');
    }
};
