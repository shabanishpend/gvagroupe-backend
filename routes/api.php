...
Route::middleware(['api.key', 'throttle:blogs'])->get('/testimonials', [App\Http\Controllers\TestimonialController::class, 'testimonials']);
Route::middleware(['api.key', 'throttle:blogs'])->get('/lasted-blogs', [App\Http\Controllers\BlogController::class, 'lastedBlogsApi']);
Route::middleware(['api.key', 'throttle:blogs'])->get('/blogs', [App\Http\Controllers\BlogController::class, 'blogsApi']);
Route::middleware(['api.key', 'throttle:blogs'])->get('/blog/{blog_id}', [App\Http\Controllers\BlogController::class, 'blogApi']);
