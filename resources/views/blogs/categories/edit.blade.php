                        ...
                        <div class="tab-content mt-3">
                            <div class="tab-pane fade show active" id="fr" role="tabpanel">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title_fr" name="title_fr" placeholder="Titre" value="{{ old('title_fr', $blogCategory->title_fr ?? $blogCategory->title) }}" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="description_fr">Description</label>
                                    <textarea class="form-control" id="description_fr" name="description_fr" rows="5">{{ old('description_fr', $blogCategory->description_fr ?? $blogCategory->description) }}</textarea>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="en" role="tabpanel">
                                <div class="form-group mb-3">
                                    <label for="title_en">Title</label>
                                    <input type="text" class="form-control" id="title_en" name="title_en" placeholder="Title" value="{{ old('title_en', $blogCategory->title_en) }}">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="description_en">Description</label>
                                    <textarea class="form-control" id="description_en" name="description_en" rows="5">{{ old('description_en', $blogCategory->description_en) }}</textarea>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="de" role="tabpanel">
                                <div class="form-group mb-3">
                                    <label for="title_de">Titel</label>
                                    <input type="text" class="form-control" id="title_de" name="title_de" placeholder="Titel" value="{{ old('title_de', $blogCategory->title_de) }}">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="description_de">Beschreibung</label>
                                    <textarea class="form-control" id="description_de" name="description_de" rows="5">{{ old('description_de', $blogCategory->description_de) }}</textarea>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="sq" role="tabpanel">
                                <div class="form-group mb-3">
                                    <label for="title_sq">Titulli</label>
                                    <input type="text" class="form-control" id="title_sq" name="title_sq" placeholder="Titulli" value="{{ old('title_sq', $blogCategory->title_sq) }}">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="description_sq">Përshkrimi</label>
                                    <textarea class="form-control" id="description_sq" name="description_sq" rows="5">{{ old('description_sq', $blogCategory->description_sq) }}</textarea>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="it" role="tabpanel">
                                <div class="form-group mb-3">
                                    <label for="title_it">Titolo</label>
                                    <input type="text" class="form-control" id="title_it" name="title_it" placeholder="Titolo" value="{{ old('title_it', $blogCategory->title_it) }}">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="description_it">Descrizione</label>
                                    <textarea class="form-control" id="description_it" name="description_it" rows="5">{{ old('description_it', $blogCategory->description_it) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
