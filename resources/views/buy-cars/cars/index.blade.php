...
@section('title', 'Mais les voitures')
        ...
        <div class="container-fluid">
            ...
            @include('layouts.breadcrump', [
                ...
                'items' => [
                    ...
                    ['label' => 'Mais les voitures', 'active' => true]
                ]
            ])    
            @include('layouts.alerts')

            <div class="w-100 mb-3">
                <a href="{{ route('buy-cars.cars.create') }}" class="btn btn-info">Créer un nouveau véhicule</a>
            </div>

            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Mais les voitures</h5>
                </div>
                <div class="card-body">
                                    ...
                                    @foreach($cars as $car)
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <div>
                                                    <a href="{{ route('buy-cars.edit', [$car->id]) }}" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Suppression d'une voiture</h5>
            ...
            <div class="modal-footer">
                <form action="{{ route('buy-cars.delete') }}" method="POST">   
                    @csrf
...
<script>
    $(document).ready(function() {
        var carsTable = $('#basic-datatable').DataTable({
            ordering: false,
            searching: false,
            language: {
