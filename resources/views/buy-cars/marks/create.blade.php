...
@section('title', 'Nouvelle marque de voiture')
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Créer une nouvelle marque</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('buy-cars.marks.update') }}">
                        @csrf
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                                      ...
                                                      name="description" 
                                                      rows="5" 
                                                      placeholder="Entrez la description de la marque">{{ old('description') }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                                      ...
                                                      name="description_en" 
                                                      rows="5" 
                                                      placeholder="Enter mark description">{{ old('description_en') }}</textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('description_de') is-invalid @enderror" 
                                                      ...
                                                      name="description_de" 
                                                      rows="5" 
                                                      placeholder="Markenbeschreibung eingeben">{{ old('description_de') }}</textarea>
