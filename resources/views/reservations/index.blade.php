            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if(count($reservations) > 0)
                        ...
                        <tr>
                            <td style="vertical-align: middle;">{{ $reservation->type }}</td>
                            <td style="vertical-align: middle;">{{ $reservation->first_name }} {{ $reservation->last_name }}</td>
                            <td style="vertical-align: middle;">{{ $reservation->date }} {{ $reservation->time }}</td>
                            <td style="vertical-align: middle;">{{ $reservation->email }}</td>
