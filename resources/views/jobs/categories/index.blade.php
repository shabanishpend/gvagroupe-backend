        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Catégories d'emploi</h5>
                </div>
                <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="header-title">Liste des catégories d'emploi</h4>
                                <a href="{{ route('jobs.categories.create') }}" class="btn btn-primary">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 justify-content-end">
                                                            <a href="{{ route('jobs.categories.edit',[$category->id]) }}" 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Suppression d'une catégorie d'emploi</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <h5 class="fs-15">
                    Êtes-vous sûr de vouloir supprimer cette catégorie d'emploi ?
                </h5>
                <p class="text-muted">Cette action est irréversible.</p>
            </div>
            <div class="modal-footer">
                <form action="{{ route('jobs.categories.delete') }}" method="POST">   
                    @csrf
                    <input type="hidden" name="job_category_id" value="" id="job_category_id" />
