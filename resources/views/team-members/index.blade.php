    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="w-100 mb-3">
                <a href="{{ route('team-member-create') }}" class="btn btn-info">Créer un nouveau membre de l'équipe</a>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="vertical-align: middle;">
                                <img alt="Image" 
                                    src="/back/img/team-members/{{ $teamMember->image }}"
                                    width = "100"
                                    height = "100"
                                    class="object-cover"
                                />
                            </td>
                            <td style="vertical-align: middle;">{{ $teamMember->name }} {{ $teamMember->surname }}</td>
                            <td style="vertical-align: middle;">{{ $teamMember->position }}</td>
                            <td style="vertical-align: middle;">{{ $teamMember->linkedin }}</td>
                            <td style="vertical-align: middle;">
                                <div>
                                    <a href="{{ route('team-member-edit', [$teamMember->id]) }}" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                    <a href="javascript: void(0);" class="action-icon"  data-bs-toggle="modal" data-bs-target="#fill-danger-modal" onclick="onDelete({{ $teamMember->id }})"> <i class="mdi mdi-delete"></i></a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Suppression d'un membre de l'équipe</h5>
