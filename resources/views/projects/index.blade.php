    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="w-100 mb-3">
                <a href="{{ route('projects-create') }}" class="btn btn-info">Créer un nouveau projet</a>
            </div>
            ...
            @if(count($projects) > 0)
                ...
                <tr>
                    <td style="vertical-align: middle;">
                        <img alt="Image" 
                            src="/back/img/projects/{{ $project->image }}"
                            width = "100"
                            height = "100"
                            class="object-cover"
                        />
                    ...
                    <td style="vertical-align: middle;">{{ $project->client }}</td>
                    <td style="vertical-align: middle;">{{ $project->year }}</td>
                    <td style="vertical-align: middle;">{{ $project->visit }}</td>
                    <td style="vertical-align: middle;">
                        <div>
                            <a href="{{ route('projects-edit', [$project->id]) }}" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                            <a href="javascript: void(0);" class="action-icon"  data-bs-toggle="modal" data-bs-target="#fill-danger-modal" onclick="onDelete({{ $project->id }})"> <i class="mdi mdi-delete"></i></a>
                        </div>
                    </td>
                </tr>
                @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Suppression d'un projet</h5>
