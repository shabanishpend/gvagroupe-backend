        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Créer un nouveau client</h5>
                </div>
                <div class="card-body">
                <form method="POST" action="{{ route('factures.clients.update', [$website]) }}" class="row w-100" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-lg-4 col-md-6 col-sm-12 col-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="surname" id="surname" placeholder="Nom" value="{{ old('surname') }}">
                    </div>

                    <div class="form-group col-lg-4 col-md-6 col-sm-12 col-12 mb-3">
                        <label for="email">Téléphone</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="phone" id="phone" placeholder="Téléphone" value="{{ old('phone') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-lg-4 col-md-6 col-sm-12 col-12 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="postal_code" id="postal_code" placeholder="Postal Code" value="{{ old('postal_code') }}" required>
                        </div>
                    </div>
