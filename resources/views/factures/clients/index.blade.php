    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="w-100 mb-3">
                <a href="{{ route('factures.clients.create', [$website]) }}" class="btn btn-info">Créer un nouveau client</a>
            </div>
                        ...
                        @if(count($users) > 0)
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle;">
                                    <div>
                                        <a href="{{ route('factures.clients.edit',[$user->id, $website]) }}" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Suppression d'un client</h5>
            ...
            <div class="modal-footer">
                <form action="{{ route('factures.clients.delete') }}" method="POST">   
                    @csrf
