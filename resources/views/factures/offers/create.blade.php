    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form class="box" action="{{ route('factures.update',[$website]) }}" method="POST" id="pdf_form">
                ...
                <input style="min-width: 112px;" class="font_bold" type="hidden" placeholder="Écrire date" name="intervenation_date"  />
                <input style="min-width: 112px;" class="font_bold" type="hidden" placeholder="Écrire date" name="payable_end_time"  />
