...
<div class="page-content">
    <div class="container-fluid">
        ...
        <a href="{{ route('testimonials.create') }}" class="btn btn-info">Créer un nouveau témoignage</a>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                @if(count($testimonials) > 0)
                    ...
                    <tr>
                        <td style="vertical-align: middle;">
                            <img alt="Image" 
                                src="/back/img/testimonials/{{ $testimonial->user_image }}"
                                width = "100"
                                height = "100"
                                class="object-cover"
                            />
                        </td>
                        <td style="vertical-align: middle;">{{ $testimonial->user_full_name }}</td>
                        <td style="vertical-align: middle;">{{ $testimonial->title }}</td>
                        <td style="vertical-align: middle;">{{ $testimonial->user_position }}</td>
                        <td style="vertical-align: middle;">
                            {{ \Illuminate\Support\Str::limit($testimonial->description, 50, $end='...') }}
                        </td>
                        <td style="vertical-align: middle;">
                            <div>
...
function onDelete(id) {
    let team_member_id = $('#testimonial_id');
