    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="w-100 mb-3">
                <a href="{{ route('costs.sub.categories.create') }}" class="btn btn-info">Ajouter sub dépense category</a>
            </div>
                ...
                <div class="card-body">
                    ...
                    @if(count($subcategories) > 0)
                        ...
                        <tr>
                            ...
                            <a href="{{ route('costs.sub.categories.edit', [$subcategory->id]) }}" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                            <a href="javascript: void(0);" class="action-icon"  data-bs-toggle="modal" data-bs-target="#fill-danger-modal" onclick="onDelete({{ $subcategory->id }})"> <i class="mdi mdi-delete"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Suppression d'une sous-catégorie</h5>
            ...
            <div class="modal-footer">
                <form action="{{ route('costs.sub.categories.destroy') }}" method="POST">   
                    @csrf
