...
@section('title', 'Modifer un sub catégorie')
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Modifier une sous-catégorie</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                <form method="POST" action="{{ route('costs.sub.categories.update') }}" class="row w-100">
                    ...
                    <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12 mb-3">
                        ...
                        <select class="form-control select2" id="catgory_id" data-toggle="select2" name="catgory_id" required>
                            @foreach($categories as $category)
                                <option 
                                    value="{{ $category->id }}"
                                    @if($category->id == $subcategory->catgory_id) selected @endif
                                >
                                    {{ $category->name }}
                                </option>
                            @endforeach
                    ...
                    <div class="form-group col-lg-4 col-md-6 col-sm-12 col-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{ $subcategory->name }}" required>
                    </div>
