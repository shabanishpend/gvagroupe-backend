    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="w-100 mb-3">
                <a href="{{ route('costs.categories.create') }}" class="btn btn-info">Ajouter une catégorie</a>
            </div>
                ...
                <div class="card-body">
                    ...
                    @if(count($categories) > 0)
                        ...
                        <tr>
                            ...
                            <a href="javascript: void(0);" class="action-icon"  data-bs-toggle="modal" data-bs-target="#fill-danger-modal" onclick="onDelete({{ $category->id }})"> <i class="mdi mdi-delete"></i></a>
                            <a href="{{ route('costs.categories.edit', [$category->id]) }}" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{ route('costs.categories.destroy') }}" method="POST">   
                    @csrf
